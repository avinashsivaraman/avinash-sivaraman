        ...
        <section className = "section-header text-center">
          ...
          <div className="header-content">
            ...
            <div className="padding-left">
                ...
                <div className="header-hobby"> I  <span role="img" aria-label="emojis-heart">💜 </span> <div className="typewrite highlight" data-period="2000" data-type='[ "Creative Works ", "To Design  ", "To Develop ", "Working on Web Perf " ]' />
                </div>
            </div>
          </div>
          <div className="header-contact">
            ...
            <a className="section-download-btn remove-default" href='Resume.pdf' download='Avinash-Resume'>
